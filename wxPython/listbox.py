...
class MyFrame(wx.Frame):
    def __init__(self):
        super().__init__(parent=None, title='选择列表', size=(350, 180))
        self.Center()  # 设置窗口居中
        panel = wx.Panel(self)
        ...
        statictext1 = wx.StaticText(panel, label='选择你喜欢吃的水果：')
        list2 = ['苹果', '橘子', '香蕉']
        lb2 = wx.ListBox(panel, -1, choices=list2, style=wx.LB_MULTIPLE)
